...
import com.example.monapplication.Admin.activityStatistiques;
...
public class StatistiquesAdminAdapter extends BaseAdapter {
    ...
    public StatistiquesAdminAdapter(Context context, List<Concours> concoursList)
    {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent unIntent = new Intent(context, activityStatistiques.class);

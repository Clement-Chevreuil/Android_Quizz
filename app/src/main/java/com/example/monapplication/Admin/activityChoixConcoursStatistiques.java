...
import com.example.monapplication.AdminAdapter.StatistiquesAdminAdapter;
...
public class activityChoixConcoursStatistiques extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConcoursListView.setAdapter(new StatistiquesAdminAdapter(this, lesConcoursRetenu));
    }
